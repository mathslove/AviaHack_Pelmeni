...
// Добавил эмиттер, чтобы следить за добавлением тэгов
public class TagsEmitter: UIControl {
    open var tagsNumber: Int = 0 {
        didSet {
...
open class WSTagsField: UIScrollView {
    ...
    open func addTag(_ tag: WSTag) {
        ...
        readOnly = tagViews.count == tagsLimit
